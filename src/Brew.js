...
function Brew() {
  ...
  useEffect(() => {
    ...
    const svgElement = document.querySelector('#coffee_brew');
    if (svgElement) {
  ...
  const handleClick = () => {
    const grinderAudio = new Audio('/sounds/Brew.mp3');
    grinderAudio.play();
  };
  ...
  return (
    <g
      ...
      onClick={handleClick}
    >
      <polygon class="cls-11" style={{ display: isHovered ? 'block' : 'none' }} id ="coffee_brew" points="498.44 379.16 498.44 395.42 505.53 395.42 505.53 397.26 496.73 400.1 431.82 400.1 431.82 406.54 497.08 406.54 505.53 409.26 505.53 410.4 510.92 410.4 510.92 415.48 518.54 415.48 518.54 420.56 561.08 420.56 561.08 415.48 567.74 415.48 567.74 410.4 573.14 410.4 573.14 395.42 580.23 395.42 580.23 379.16 498.44 379.16"/>
