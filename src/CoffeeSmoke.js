...
function CoffeeSmoke() {
    ...
    useEffect(() => {
      ...
      const svgElement = document.querySelector('#smoke-hover');
      if (svgElement) {
    ...
    const handleClick = () => {
      const grinderAudio = new Audio('/sounds/Pour Coffee Short.mp3');
      grinderAudio.play();
    };
